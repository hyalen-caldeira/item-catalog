...
def editRestaurant(restaurant_id):
    ...
    if request.method == 'POST':
        ...
        return render_template(
            'edit_restaurant.html', restaurant=editedRestaurant)
...
def deleteRestaurant(restaurant_id):
    ...
    if request.method == 'POST':
        ...
        return render_template(
            'delete_restaurant.html', restaurant=restaurantToDelete)
...
def editMenuItem(restaurant_id, menu_id):
    ...
    if request.method == 'POST':
        ...
        return render_template(
            'edit_menu_item.html', restaurant_id=restaurant_id, menu_id=menu_id, item=editedItem)
